...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="brutal-card bg-background max-w-md w-full p-8 text-center animate-bounce-in">
        ...
        <button
          ...
          className="brutal-btn w-full py-4 rounded-xl text-xl bg-primary text-primary-foreground hover-bounce flex items-center justify-center gap-3"
        >
